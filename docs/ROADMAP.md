...
- Outbound-only Windows worker, versioned capability handshake, heartbeats, cancellation, Blender → Unreal → FFmpeg execution, and verified artifact upload (implemented; real GPU smoke test and compute settlement pending)
